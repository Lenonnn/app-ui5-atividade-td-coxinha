sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("AppCoxinha/AppCoxinha/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("AppCoxinha.AppCoxinha.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["AppCoxinha/AppCoxinha/localService/mockserver"], function (mockserver) {
