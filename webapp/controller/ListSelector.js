sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("AppCoxinha.AppCoxinha.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias AppCoxinha.AppCoxinha.controller.ListSelector
			 */
			 ...
			 * @return {AppCoxinha.AppCoxinha.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
